...
// ========== FIXED: Correct Context Order ==========
// NotificationProvider must be OUTSIDE ChatProvider
// Because ChatProvider depends on registerChatRefresh from NotificationContext
function App() {
  return (
    <AuthProvider>
      <PostProvider>
